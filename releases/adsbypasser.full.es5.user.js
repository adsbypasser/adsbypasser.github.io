...
// @icon           https://raw.githubusercontent.com/adsbypasser/adsbypasser/v6.35.0/resources/img/logo.png
...
// @grant          unsafeWindow
// @resource       alignCenter https://raw.githubusercontent.com/adsbypasser/adsbypasser/v6.35.0/resources/css/align_center.css
// @resource       scaleImage https://raw.githubusercontent.com/adsbypasser/adsbypasser/v6.35.0/resources/css/scale_image.css
// @resource       bgImage https://raw.githubusercontent.com/adsbypasser/adsbypasser/v6.35.0/resources/img/imagedoc-darknoise.png
...
var _asyncToGenerator2 = __webpack_require__(76);
var _asyncToGenerator3 = _interopRequireDefault(_asyncToGenerator2);
var _ADSBYPASSER_NAMESPACE__ = __webpack_require__(164);
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
    ...
    var _ref13 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee11() {
      ...
      return _regenerator2.default.wrap(function _callee11$(_context11) {
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
              _ADSBYPASSER_NAMESPACE__._.wait(1);
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  start: function () {
    var _ref15 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee13(m) {
...
_ADSBYPASSER_NAMESPACE__._.register({
  rule: {
    host: [/^openload\.(co|pw)$/, /^oload\.(stream|info|site|tv|win|download|cloud|cc|fun|club|live|space)$/, /^oladblock\.(services|xyz|me)$/],
    path: /^\/f\/.*/
  },
  start: function () {
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  start: function () {
    var _ref25 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee23(m) {
...
_ADSBYPASSER_NAMESPACE__._.register({
  rule: {
    host: [/^al\.ly$/, /^ally\.sh$/, /^ally\.shortens\.co$/, /^dausel\.co$/]
  },
  ready: function () {
...
(function () {
  var run = function () {
    var _ref53 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee51(dirtyFix) {
      var result;
  ...
  _ADSBYPASSER_NAMESPACE__._.register({
    ...
    start: function () {
      var _ref48 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee46(m) {
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  start: function () {
    var _ref57 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee55(m) {
      var direct_link;
...
(function () {
  _ADSBYPASSER_NAMESPACE__._.register({
    ...
    ready: function () {
      var _ref63 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee61(m) {
        var mapper, b64;
      ...
      return _regenerator2.default.wrap(function _callee63$(_context63) {
        while (1) {
          switch (_context63.prev = _context63.next) {
            ...
            case 5:
              mainFrameContent = _context63.sent;
              docMainFrame = null;
              _context63.prev = 7;
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  start: function () {
    var _ref77 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee75(m) {
      var url;
...
(function () {
  var sendRequest = function () {
    var _ref96 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee94(token) {
      var text, data;
        ...
        while (1) {
          switch (_context94.prev = _context94.next) {
            ...
            case 20:
              ...
              return _context94.abrupt('return', data.Url);
            case 22:
            case 'end':
    ...
    return function sendRequest(_x19) {
...
(function () {
  var getJQueryForm = function () {
    var _ref123 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee121(selector) {
      var jQuery, f;
        ...
        while (1) {
          switch (_context121.prev = _context121.next) {
            ...
            case 7:
              ...
              return _context121.abrupt('return', f);
            case 10:
    ...
    return function getJQueryForm(_x30) {
  ...
  _ADSBYPASSER_NAMESPACE__._.register({
    rule: {
      host: [
      /^(dz4link|gocitlink|3rabcut|short2win|adsrt|shortglobal|jainjinvani)\.com$/, /^(payshorturl|urltips|shrinkearn|itiad|cutsouf|enewstalk|lnks4all|jejaklagu)\.com$/, /^(earn-url|bit-url|cut-win|link-zero|cut-earn|oturl|glory-link|coolmitten)\.com$/, /^(empireshort|empearn|tarnwh2i|tabeikh|yourw-ay|reb7konline|factural)\.com$/, /^(shrinkbuck|clkpay|linksht|haxrs|click2-url|cooltxtgen|arba7co|shortlinko)\.com$/, /^(partqb2i|khraba|adlpu|tabakhelo|amenitiees|cosmicmony)\.com$/, /^(vy\.)?adsvy\.com$/, /^(www\.)?(clkpays|lnkjob)\.com$/, /^(linkexa|admew|shrtfly|kuylink|cut4links|adskipme|skipurls|ely-om7)\.com$/, /^(smarteasystudy|cyahealth|ershadat|z2i|srtfly|arba7kpro|shrt10)\.com$/, /^(blogginggyanbox|yourtechguider|gifsis|3rab-cash|pinkhindi|wishes2)\.com$/, /^(mykinggo|li-nkz|win4cut|khabratk|programsfre|safelinkblogger)\.com$/, /^(linkorlink|mrfourtech|fabsdeals|tech4utoday|urlsamo|icutlink)\.com$/, /^(earnmoneytalk|newupdatesonline|uptoos|bakilink|gossipcorners)\.com$/,
      /^(safelinku|tinylinks|licklink|linkrex|zlshorte|vivads)\.net$/, /^(vnurl|vinaurl|foxurl|short2win|cashat|shrtfly)\.net$/, /^(link4win|linksad|topurl|xemlink|cutadlink|crabcut)\.net$/,
      /^(clik|tokenfly|getlink|psl|pss|shln|lpe|chrt|szs|miniurl)\.pw$/, /^(www\.)?lwt\.pw$/,
      /^(trlink|wolink|tocdo|cuturl|counsellingresult2016|iitjeemainguide|healthhindigyan)\.in$/, /^(utimetableresult)\.in$/, /^(petty|skips|tr|flaz)\.link$/, /^megaurl\.(in|link)$/, /^(adbilty|adpop|ujv|tpx|adsrt|2fly|lin65|short2win|suarankri)\.me$/, /^payskip\.(me|org)$/, /^(oke|cuon|cuio|cuee|cuus|cuto|cu2|linktor|flylink|uiz)\.io$/, /^(3bst|coinlink|itiurl|coshink|link5s|curs|makeurl)\.co$/, /^(shink|shrten|gg-l|vnurl|bloggingdekh|ln11|sh11|tradeguru|newskart|kidsors)\.xyz$/, /^(techinhub|viralnow|shophipro|technocanvas|getfreshcloud)\.xyz$/, /^(mlink|cl250|xpickle)\.club$/, /^(igram|gram|pingit)\.im$/, /^(clk|cll)\.(press|ink|sh|icu)$/, /^short\.pe$/, /^(urlcloud|imageoptimizer)\.us$/, /^(icutit|earnbig|cutearn)\.ca$/, /^(adzurl|link2link)\.cf$/, /^(koylinks|buy-in-599rs)\.win$/, /^lopte\.pro$/, /^(www\.)?pnd\.tl$/, /^(tny|tiny)\.ec$/, /^tl\.tc$/, /^e2s\.cc$/, /^lyon\.kim$/, /^(linkvip|4short)\.tk$/, /^stfly\.press$/, /^(businessiss2|techandreview|yesmoviesapp|kpscthulasilogin)\.info$/, /^eatings\.stream$/, /^8o\.ee$/, /^buyitonline\.store$/, /^shortearn\.eu$/, /^(1921681254|geki)\.tech$/, /^123link\.(pw|vip)$/, /^123link\.carpartsviet97\.site$/, /^(lotechnocan|updatetribun)\.org$/, /^tinylink\.run$/, /^btc\.ms$/, /^earn\.theplusit\.ro$/, /^skip\.az$/, /^(dutchycorp|abouttech)\.space$/, /^click2see\.desi$/, /^shorted\.id$/, /^zi\.ht$/, /^funnyquiz\.blog$/, /^sciencelife\.ga$/, /^thin\.at$/, /^(click2url|ln435)\.online$/, /^sk-ip\.ru$/, /^slink\.bid$/, /^za\.gl$/]
    },
    ready: function () {
  ...
  _ADSBYPASSER_NAMESPACE__._.register({
    rule: {
      host: [/^(cutpaid|tmearn)\.com$/, /^(ctui|cuti)\.in$/, /^zutrox\.link$/, /^(www\.)?shrink\.vip$/, /^cutwin\.us$/]
    },
    ready: function () {
  ...
  var NoRecaptchaHandler = function (_AbstractHandler) {
    ...
    function NoRecaptchaHandler() {
      ...
      return (0, _possibleConstructorReturn3.default)(this, (NoRecaptchaHandler.__proto__ || (0, _getPrototypeOf2.default)(NoRecaptchaHandler)).apply(this, arguments));
    }
    (0, _createClass3.default)(NoRecaptchaHandler, [{
      ...
      key: 'getURL',
      value: function () {
        var _ref109 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee107(jForm) {
  ...
  var RecaptchaHandler = function (_AbstractHandler2) {
    ...
    function RecaptchaHandler() {
      ...
      return (0, _possibleConstructorReturn3.default)(this, (RecaptchaHandler.__proto__ || (0, _getPrototypeOf2.default)(RecaptchaHandler)).apply(this, arguments));
    }
    (0, _createClass3.default)(RecaptchaHandler, [{
            ...
            while (1) {
              switch (_context108.prev = _context108.next) {
                case 0:
                  ...
                  return _context108.abrupt('return', true);
                case 4:
                  ...
                  return _context108.abrupt('return', false);
                case 9:
                  _context108.next = 11;
      ...
      key: 'submitListen',
      value: function () {
        var _ref111 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee109(b) {
          var o;
      ...
      key: 'getURL',
      value: function () {
        var _ref113 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee111(jForm) {
          var url;
            ...
            while (1) {
              switch (_context111.prev = _context111.next) {
                ...
                case 6:
                  ...
                  return _context111.abrupt('return', url);
                case 9:
                  _context111.next = 14;
                  break;
                case 11:
                  ...
                  _ADSBYPASSER_NAMESPACE__._.warn(_context111.t0);
                case 14:
                  _context111.next = 0;
                  break;
                case 16:
  ...
  var InvisibleRecaptchaHandler = function (_RecaptchaHandler) {
    ...
    function InvisibleRecaptchaHandler() {
      ...
      return (0, _possibleConstructorReturn3.default)(this, (InvisibleRecaptchaHandler.__proto__ || (0, _getPrototypeOf2.default)(InvisibleRecaptchaHandler)).apply(this, arguments));
    }
    (0, _createClass3.default)(InvisibleRecaptchaHandler, [{
      key: 'submitListen',
      value: function () {
        var _ref114 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee112(b, f) {
          var click;
        ...
        function submitListen(_x24, _x25) {
  ...
  var NonDisabledRecaptchaHandler = function (_RecaptchaHandler2) {
    ...
    function NonDisabledRecaptchaHandler() {
      ...
      return (0, _possibleConstructorReturn3.default)(this, (NonDisabledRecaptchaHandler.__proto__ || (0, _getPrototypeOf2.default)(NonDisabledRecaptchaHandler)).apply(this, arguments));
    }
    (0, _createClass3.default)(NonDisabledRecaptchaHandler, [{
      key: 'submitListen',
      value: function () {
        var _ref115 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee113(b) {
            ...
            while (1) {
              switch (_context113.prev = _context113.next) {
                ...
                case 3:
                  ...
                  b.click();
                  return _context113.abrupt('break', 8);
                case 6:
                  _context113.next = 0;
                  break;
                case 8:
  ...
  var OURLHandler = function (_RecaptchaHandler3) {
    ...
    function OURLHandler() {
      ...
      return (0, _possibleConstructorReturn3.default)(this, (OURLHandler.__proto__ || (0, _getPrototypeOf2.default)(OURLHandler)).apply(this, arguments));
    }
    (0, _createClass3.default)(OURLHandler, [{
      ...
      key: 'getURL',
      value: function () {
        var _ref117 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee115(jFormObject) {
  ...
  var LinkDropHandler = function (_RecaptchaHandler4) {
    ...
    function LinkDropHandler() {
      ...
      return (0, _possibleConstructorReturn3.default)(this, (LinkDropHandler.__proto__ || (0, _getPrototypeOf2.default)(LinkDropHandler)).apply(this, arguments));
    }
  ...
  var StagedHandler = function (_AbstractHandler3) {
    ...
    function StagedHandler() {
      ...
      return (0, _possibleConstructorReturn3.default)(this, (StagedHandler.__proto__ || (0, _getPrototypeOf2.default)(StagedHandler)).apply(this, arguments));
    }
    (0, _createClass3.default)(StagedHandler, [{
            ...
            while (1) {
              switch (_context117.prev = _context117.next) {
                case 0:
                  ...
                  return _context117.abrupt('return', document);
                case 3:
                ...
                case 7:
                  page = _context117.sent;
                  page = _ADSBYPASSER_NAMESPACE__.$.toDOM(page);
                  return _context117.abrupt('return', page);
                case 10:
                case 'end':
      ...
      key: 'getURL',
      value: function () {
        var _ref120 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee118(page) {
          var f, args, url, data;
  ...
  var ShortlyHandler = function (_AbstractHandler4) {
    ...
    function ShortlyHandler() {
      ...
      return (0, _possibleConstructorReturn3.default)(this, (ShortlyHandler.__proto__ || (0, _getPrototypeOf2.default)(ShortlyHandler)).apply(this, arguments));
    }
    (0, _createClass3.default)(ShortlyHandler, [{
            ...
            while (1) {
              switch (_context119.prev = _context119.next) {
                case 0:
                  ...
                  return _context119.abrupt('return', a[1]);
                case 3:
                case 'end':
      ...
      key: 'getURL',
      value: function () {
        var _ref122 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee120(id) {
          return _regenerator2.default.wrap(function _callee120$(_context120) {
            while (1) {
              switch (_context120.prev = _context120.next) {
                case 0:
                  if (false) {}
                  _ADSBYPASSER_NAMESPACE__.$.window.jQuery.post('getlink.php', { id: id }).done(function (url) {
                    if (url.match(/^http/)) {
        ...
        while (1) {
          switch (_context124.prev = _context124.next) {
            ...
            case 6:
              ...
              return _context124.abrupt('break', 13);
            case 10:
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  start: function () {
    var _ref129 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee127(m) {
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  start: function () {
    var _ref133 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee131(m) {
      var url;
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  start: function () {
    var _ref140 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee138(m) {
      var url;
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  start: function () {
    var _ref153 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee151(m) {
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  start: function () {
    var _ref165 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee163(m) {
      var url;
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  start: function () {
    var _ref172 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee170(m) {
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  },
  {
    ...
    /^(www\.)?tojros\.tk$/, /^(www\.)?anjay\.info$/, /^(www\.)?kakkoiisafe\.us$/, /^(www\.)?kurosafe\.(website|online)$/, /^(fmlawkers|indexmovie)\.club$/, /^micin\.online$/, /^unduh\.in/, /^(www\.)?drakorsafe\.tech$/, /^(omgmusik|omglyrics)\.com$/, /^ad4msan\.win$/],
    query: [
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  start: function () {
    var _ref176 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee174(m) {
      var l;
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  ready: function () {
    var _ref179 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee177(m) {
      var s;
...
(function () {
  var getURL = function () {
    var _ref220 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee218(url) {
      var text, goodURL;
...
(function () {
  _ADSBYPASSER_NAMESPACE__._.register({
    ...
    ready: function () {
      var _ref221 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee219(m) {
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  ready: function () {
    var _ref236 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee234(m) {
      var url;
      ...
      return _regenerator2.default.wrap(function _callee235$(_context235) {
        while (1) {
          switch (_context235.prev = _context235.next) {
            case 0:
              img = (0, _ADSBYPASSER_NAMESPACE__.$)('#picContainer #image:last-child');
              _context235.next = 3;
              return _ADSBYPASSER_NAMESPACE__.$.openImage(img.src, {
                referer: true
              });
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  start: function () {
    var _ref243 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee241(m) {
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  start: function () {
    var _ref244 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee242(m) {
...
(function () {
  ...
  _ADSBYPASSER_NAMESPACE__._.register({
    ...
    start: function () {
      var _ref246 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee244(m) {
  ...
  _ADSBYPASSER_NAMESPACE__._.register({
    ...
    start: function () {
      var _ref247 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee245(m) {
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  ready: function () {
    var _ref249 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee247() {
      var m;
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  start: function () {
    var _ref251 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee249(m) {
...
(function () {
  var run = function () {
    var _ref262 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee260(rp) {
      var i;
        ...
        while (1) {
          switch (_context265.prev = _context265.next) {
            case 0:
              ...
              return _ADSBYPASSER_NAMESPACE__.$.openLink(a.href);
            case 4:
              return _context265.abrupt('return');
            case 5:
...
(function () {
  var helper = function () {
    var _ref272 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee270(doReplace) {
      var i;
...
(function () {
  var getAmbiguousForm = function () {
    var _ref284 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee282(selector, shellNormalizer) {
        ...
        while (1) {
          switch (_context282.prev = _context282.next) {
            ...
            case 6:
              ...
              return _context282.abrupt('return', button);
            case 10:
              _context282.next = 12;
              return _ADSBYPASSER_NAMESPACE__._.wait(500);
            case 12:
    ...
    return function getAmbiguousForm(_x63, _x64) {
      return _ref284.apply(this, arguments);
    };
  }();
  var helper = function () {
    var _ref285 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee283(id, getNext) {
    ...
    return function helper(_x65, _x66) {
      return _ref285.apply(this, arguments);
    };
  }();
  var go = function () {
    var _ref286 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee284(id, pre, next) {
    ...
    return function go(_x67, _x68, _x69) {
  ...
  _ADSBYPASSER_NAMESPACE__._.register({
    ...
    ready: function () {
      var _ref274 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee272(m) {
          ...
          while (1) {
            switch (_context274.prev = _context274.next) {
              case 0:
                ...
                return _ADSBYPASSER_NAMESPACE__.$.openImage(i.src);
              case 4:
                return _context274.abrupt('return');
              case 5:
          ...
          while (1) {
            switch (_context275.prev = _context275.next) {
              case 0:
                ...
                return _ADSBYPASSER_NAMESPACE__.$.openImage(i.src);
              case 5:
                return _context275.abrupt('return');
              case 6:
                _ADSBYPASSER_NAMESPACE__.$.window._0x5b50b7 = null;
                node = null;
              case 8:
  ...
  _ADSBYPASSER_NAMESPACE__._.register({
    rule: {
      host: [/^imgfiles\.org$/, /^picbaron\.com$/, /^imgbaron\.com$/],
      path: PATH_RULE
    },
    ready: function () {
          ...
          while (1) {
            switch (_context276.prev = _context276.next) {
              case 0:
                ...
                return _ADSBYPASSER_NAMESPACE__.$.openImage(i.src);
              case 4:
                return _context276.abrupt('return');
              case 5:
                f = (0, _ADSBYPASSER_NAMESPACE__.$)('form');
                f.submit();
              case 7:
          ...
          while (1) {
            switch (_context278.prev = _context278.next) {
              case 0:
                ...
                return _ADSBYPASSER_NAMESPACE__.$.openImage(i.src);
              case 4:
                return _context278.abrupt('return');
              case 5:
                _context278.next = 7;
  ...
  _ADSBYPASSER_NAMESPACE__._.register({
    ...
    start: function () {
      var _ref282 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee280(m) {
  ...
  function filterDuplicated(classes) {
    ...
    return (0, _from2.default)(table.entries()).filter(function (unique) {
      return unique;
    }).map(function (_, c) {
      return c;
    });
  ...
  function findVisibleForm(classes) {
    ...
    try {
      for (var _iterator2 = (0, _getIterator3.default)(classes), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        ...
        var form = _ADSBYPASSER_NAMESPACE__.$.$('form.' + class_);
        if (!form) {
          continue;
        }
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  start: function () {
    var _ref293 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee291(m) {
...
(function () {
  var helper = function () {
    var _ref298 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee296(m) {
  ...
  _ADSBYPASSER_NAMESPACE__._.register({
    ...
    start: function () {
      var _ref295 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee293(m) {
  ...
  _ADSBYPASSER_NAMESPACE__._.register({
    ...
    start: function () {
      var _ref297 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee295(m) {
...
_ADSBYPASSER_NAMESPACE__._.register({
  rule: {
    host: [/^pic-money\.ru$/, /^shaggyimg\.pro$/, /^imgazure\.com$/]
  },
  ready: function () {
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  ready: function () {
    var _ref307 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee305() {
      var o;
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  ready: function () {
    var _ref309 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee307() {
      var i;
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  ready: function () {
    var _ref310 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee308() {
      var i;
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  ready: function () {
    var _ref311 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee309() {
      var i;
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  ready: function () {
    var _ref312 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee310() {
      var img;
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  ready: function () {
    var _ref316 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee314() {
      var img;
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  start: function () {
    var _ref319 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee317(m) {
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  ready: function () {
    var _ref320 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee318() {
      var i;
...
(function () {
  var action = function () {
    var _ref332 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee330(firstSelector, secondSelector) {
      var node;
        ...
        while (1) {
          switch (_context330.prev = _context330.next) {
            case 0:
              ...
              node.click();
              return _context330.abrupt('return');
            case 8:
    ...
    return function action(_x76, _x77) {
  ...
  _ADSBYPASSER_NAMESPACE__._.register({
    rule: [{
      host: [
      /^(imagecorn|imagedecode|imageko|imageshtorm)\.com$/, /^(hosturimage|greasyimage|damimage)\.com$/, /^(imgicy|imgsavvy|imgtzar|imgtornado|imgkicks|img2share|imghit|imgmain)\.com$/, /^(imgtrial|imgreputa|imgfapper|imgpart|imgbalana|imgjazz)\.com$/, /^(i\.)?imgseeds?\.com$/, /^(img-planet|img-pay)\.com$/, /^(www\.)?(imglemon|imageblinks)\.com$/, /^(www\.)?(multiimg)\.com$/, /^xxxscreens\.com$/, /^(wpc8|dimtus|tinizo|erimge|nimzshare|hdmoza)\.com$/, /^(i|xxx)\.hentaiyoutube\.com$/,
      ...
      /^www\.hotimage\.uk$/, /^imgcloud\.co$/, /^pixup\.us$/, /^(pop-img|ads-img)\.info$/, /^(domaink|porno-pirat)\.ru$/, /^xxx\.pornscreen\.xyz$/, /^darpix\.ga$/, /^ipicture\.su$/, /^acidimg\.cc$/, /^s\.imghost\.top$/, /^xxx\.sexex\.xyz$/, /^imagespublic\.tk$/, /^ecoimages\.xyz$/],
      path: /\/img-.*\.html/
    }, {
  ...
  _ADSBYPASSER_NAMESPACE__._.register({
    ...
    ready: function () {
      var _ref321 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee319() {
        var node;
          ...
          while (1) {
            switch (_context319.prev = _context319.next) {
              case 0:
                ...
                node.click();
                node.click();
                return _context319.abrupt('return');
              case 6:
                _ADSBYPASSER_NAMESPACE__.$.resetCookies();
  ...
  _ADSBYPASSER_NAMESPACE__._.register({
    rule: [{
      ...
      host: [/^imgkings\.com$/, /^imagerar\.com$/],
      path: /^\/img-.*\.html/
    }],
    ready: function () {
  ...
  _ADSBYPASSER_NAMESPACE__._.register({
    ...
    ready: function () {
      var _ref328 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee326() {
        var a;
          ...
          while (1) {
            switch (_context326.prev = _context326.next) {
              case 0:
                ...
                return _ADSBYPASSER_NAMESPACE__.$.openLink(a.href);
              case 4:
                return _context326.abrupt('return');
              case 5:
  ...
  _ADSBYPASSER_NAMESPACE__._.register({
    ...
    start: function () {
      var _ref330 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee328() {
        var path;
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  ready: function () {
    var _ref333 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee331() {
      var img;
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  ready: function () {
    var _ref334 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee332() {
      var i;
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  ready: function () {
    var _ref335 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee333() {
      var i;
...
var _ajax = __webpack_require__(165);
var _cookie = __webpack_require__(166);
var _core = __webpack_require__(77);
var _dispatcher = __webpack_require__(136);
var _dom = __webpack_require__(167);
var _image = __webpack_require__(168);
