...
// @grant          unsafeWindow
// @resource       alignCenter https://raw.githubusercontent.com/adsbypasser/adsbypasser/v6.8.0/resources/css/align_center.css
// @resource       scaleImage https://raw.githubusercontent.com/adsbypasser/adsbypasser/v6.8.0/resources/css/scale_image.css
// @resource       bgImage https://raw.githubusercontent.com/adsbypasser/adsbypasser/v6.8.0/resources/img/imagedoc-darknoise.png
        ...
        while (1) {
          switch (_context19.prev = _context19.next) {
            ...
            case 2:
              ...
              ePath = (0, _ADSBYPASSER_NAMESPACE__.$)('#streamurj');
...
_ADSBYPASSER_NAMESPACE__._.register({
  rule: {
    host: [/^gsurl\.(me|in)$/, /^g5u\.pw$/, /^gurl\.ly$/]
  },
  ready: function () {
...
_ADSBYPASSER_NAMESPACE__._.register({
  rule: [{
    host: [/^(designinghomey|ani-share|sinopsisfilmku|autolinkach)\.com$/, /^motonews\.club$/, /^(autofans|landscapenature)\.pw$/, /^(sidespace|erogedownload)\.net$/, /^otoviral\.racing$/, /^www\.lifesurance\.info$/],
    query: /get=([^&]+)/
  }, {
    host: /^sipkur\.us$/,
    path: /\.html$/
...
(function () {
  var getAmbiguousForm = function () {
    var _ref320 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee318(selector, shellNormalizer) {
        ...
        while (1) {
          switch (_context318.prev = _context318.next) {
            ...
            case 12:
              ...
              _ret = _loop(form);
              _context318.t0 = _ret;
              _context318.next = _context318.t0 === 'continue' ? 18 : 19;
              break;
            case 18:
              return _context318.abrupt('continue', 21);
            case 19:
              if (!((typeof _ret === 'undefined' ? 'undefined' : (0, _typeof3.default)(_ret)) === "object")) {
                _context318.next = 21;
                break;
              }
              return _context318.abrupt('return', _ret.v);
            case 21:
              _iteratorNormalCompletion = true;
              _context318.next = 12;
              break;
            ...
            case 26:
              _context318.prev = 26;
              _context318.t1 = _context318['catch'](10);
              _didIteratorError = true;
              _iteratorError = _context318.t1;
            case 30:
              _context318.prev = 30;
              _context318.prev = 31;
              if (!_iteratorNormalCompletion && _iterator.return) {
            ...
            case 33:
              ...
              throw _iteratorError;
            case 36:
              return _context318.finish(33);
            case 37:
              return _context318.finish(30);
            case 38:
              return _context318.abrupt('return', null);
            case 39:
            case 'end':
              return _context318.stop();
          }
        }
      }, _callee318, this, [[10, 26, 30, 38], [31,, 33, 37]]);
    }));
    return function getAmbiguousForm(_x74, _x75) {
      return _ref320.apply(this, arguments);
    };
  }();
  var helper = function () {
    var _ref321 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee319(id, getNext) {
    ...
    return function helper(_x76, _x77) {
      return _ref321.apply(this, arguments);
    };
  }();
  var go = function () {
    var _ref322 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee320(id, pre, next) {
    ...
    return function go(_x78, _x79, _x80) {
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  start: function () {
    var _ref329 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee327(m) {
...
_ADSBYPASSER_NAMESPACE__._.register({
  rule: {
    host: [/^www\.pixsense\.net$/, /^www\.imagespicy\.site$/, /^www\.imgsky\.net$/],
    path: /^\/site\/v\/\d+$/
  },
  ready: function () {
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  start: function () {
    var _ref357 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee355(m) {
...
(function () {
        ...
        while (1) {
          switch (_context360.prev = _context360.next) {
            case 0:
              ...
              return _ADSBYPASSER_NAMESPACE__.$.get(window.location.toString());
            case 3:
              data = _context360.sent;
              return _context360.abrupt('return', _ADSBYPASSER_NAMESPACE__.$.toDOM(data));
            case 5:
            case 'end':
  ...
  var action = function () {
    var _ref368 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee366(firstSelector, secondSelector) {
      var node, i;
    ...
    return function action(_x89, _x90) {
