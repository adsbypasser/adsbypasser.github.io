...
// @icon           https://raw.githubusercontent.com/adsbypasser/adsbypasser/v6.14.0/resources/img/logo.png
...
// @grant          unsafeWindow
// @resource       alignCenter https://raw.githubusercontent.com/adsbypasser/adsbypasser/v6.14.0/resources/css/align_center.css
// @resource       scaleImage https://raw.githubusercontent.com/adsbypasser/adsbypasser/v6.14.0/resources/css/scale_image.css
// @resource       bgImage https://raw.githubusercontent.com/adsbypasser/adsbypasser/v6.14.0/resources/img/imagedoc-darknoise.png
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  start: function () {
    var _ref13 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee11(m) {
      return _regenerator2.default.wrap(function _callee11$(_context11) {
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  start: function () {
    var _ref22 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee20(m) {
...
(function () {
  var run = function () {
    var _ref48 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee46(dirtyFix) {
      var result;
  ...
  _ADSBYPASSER_NAMESPACE__._.register({
    ...
    start: function () {
      var _ref43 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee41(m) {
      ...
      return _regenerator2.default.wrap(function _callee57$(_context57) {
        while (1) {
          switch (_context57.prev = _context57.next) {
            ...
            case 5:
              mainFrameContent = _context57.sent;
              docMainFrame = null;
              _context57.prev = 7;
...
(function () {
  var sendRequest = function () {
    var _ref86 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee84(token) {
      var text, data;
        ...
        while (1) {
          switch (_context84.prev = _context84.next) {
            ...
            case 20:
              ...
              return _context84.abrupt('return', data.Url);
            case 22:
            case 'end':
    ...
    return function sendRequest(_x17) {
  ...
  var hostRules = [/^(([\w]{8}|www)\.)?(allanalpass|drstickyfingers|whackyvidz)\.com$/, /^(([\w]{8}|www)\.)?(filesonthe|poontown|seriousdeals|urlbeat|zatnawqy)\.net$/, /^(([\w]{8}|www)\.)?freean\.us$/, /^(([\w]{8}|www)\.)?link(babes|bucks)\.com$/, /^(([\w]{8}|www)\.)?(miniurls|qqc|rqq|tinylinks|yyv)\.co$/, /^(([\w]{8}|www)\.)?theseblogs\.com$/, /^(([\w]{8}|www)\.)?youfap\.me$/, /^warning-this-linkcode-will-cease-working-soon\.www\.linkbucksdns\.com$/];
  _ADSBYPASSER_NAMESPACE__._.register({
    rule: {
      host: hostRules,
      path: /^\/\w+\/url\/(.+)$/
    ...
    ready: function () {
      var _ref82 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee80(m) {
        var url, match;
...
(function () {
  _ADSBYPASSER_NAMESPACE__._.register({
    rule: {
      host: [/^dmus\.in$/, /^ulshare\.net$/, /^adurl\.id$/, /^earn-guide\.com$/, /^(cutwin|cut-earn)\.com$/, /^(cutwi|cut-w|cutl)\.in$/, /^(www\.)?jurl\.io$/, /^mitly\.us$/, /^tui\.click$/, /^met\.bz$/]
    },
    ready: function () {
  ...
  _ADSBYPASSER_NAMESPACE__._.register({
    rule: {
      host: [/^idsly\.com$/, /^(adbilty|adpop)\.me$/, /^(oke|cuon)\.io$/, /^linkrex\.net$/, /^safelinku\.net$/, /^(3bst|coinlink|itiurl)\.co$/, /^3rabcut\.com$/, /^(shink|shrten|gg-l)\.xyz$/, /^mlink\.club$/, /^zlshorte\.net$/, /^(igram|gram)\.im$/, /^(trlink|wolink|tocdo)\.in$/, /^tr\.link$/, /^dz4link\.com$/, /^short2win\.com$/, /^(vn|vina|fox)url\.net$/, /^clk\.press$/, /^short\.pe$/, /^urlcloud\.us$/, /^(www\.)?linkdrop\.net$/, /^(123link|clik|tokenfly)\.pw$/, /^(vy\.)?adsvy\.com$/, /^cut4links\.com$/, /^(tmearn|payshorturl|urltips|shrinkearn)\.com$/, /^(earn-url|bit-url)\.com$/, /^megaurl\.in$/, /^(icutit|earnbig)\.ca$/, /^koylinks\.win$/, /^lopte\.pro$/, /^(www\.)?pnd\.tl$/, /^(tny|tiny)\.ec$/, /^(linkexa|admew|shrtfly|kuylink)\.com$/, /^tl\.tc$/, /^petty\.link$/, /^wi\.cr$/]
    },
    ready: function () {
  ...
  _ADSBYPASSER_NAMESPACE__._.register({
    rule: {
      host: [/^(psl|twik)\.pw$/, /^coshink\.co$/, /^(curs|crus|4cut)\.io$/, /^(cut-urls|link-zero)\.com$/, /^adslink\.pw$/, /^dzurl\.ml$/, /^petty\.link$/, /^u2s\.io$/, /^shortad\.cf$/, /^link4\.me$/, /^urle\.co$/, /^taive\.in$/, /^www\.worldhack\.net$/, /^123link\.(io|co|press)$/, /^git\.tc$/, /^adfu\.us$/, /^short\.pastewma\.com$/, /^l2s\.io$/, /^adbilty\.in$/, /^linkfly\.gaosmedia\.com$/, /^linclik\.com$/, /^zeiz\.me$/, /^adbull\.me$/, /^adshort\.co$/, /^(adshorte|adsrt)\.com$/, /^(weefy|payskip)\.me$/, /^premiumzen\.com$/, /^cut4link\.com$/, /^(cutearn|shortit)\.ca$/, /^(www\.)?viralukk\.com$/, /^shrt10\.com$/, /^mikymoons\.com$/, /^spamlink\.org$/, /^royurls\.bid$/, /^(itiad|by6dk)\.com$/, /^(ot|load)url\.com$/, /^man2pro\.com$/, /^raolink\.com$/, /^eklink\.net$/]
    },
    ready: function () {
  ...
  var AbstractHandler = function () {
    function AbstractHandler() {
      ...
      this._overlaySelector = ['[class$="Overlay"]', '#__random_class_name__'].join(', ');
  ...
  var NoRecaptchaHandler = function (_AbstractHandler) {
    ...
    (0, _createClass3.default)(NoRecaptchaHandler, [{
          ...
          return _regenerator2.default.wrap(function _callee92$(_context92) {
            while (1) {
              switch (_context92.prev = _context92.next) {
                case 0:
                  return _context92.abrupt('return', getJQueryForm(this._formSelector));
                case 1:
                case 'end':
      ...
      key: 'getURL',
      value: function () {
        var _ref95 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee93(jForm) {
  ...
  var RecaptchaHandler = function (_AbstractHandler2) {
    ...
    (0, _createClass3.default)(RecaptchaHandler, [{
          ...
          return _regenerator2.default.wrap(function _callee94$(_context94) {
            while (1) {
              switch (_context94.prev = _context94.next) {
                case 0:
                  return _context94.abrupt('return', getJQueryForm(this._formSelector));
                case 1:
                case 'end':
      ...
      key: 'getURL',
      value: function () {
        var _ref97 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee95(jForm) {
          var url;
            ...
            while (1) {
              switch (_context95.prev = _context95.next) {
                ...
                case 6:
                  ...
                  return _context95.abrupt('return', url);
                case 9:
                  _context95.next = 14;
                  break;
                case 11:
  ...
  var OURLHandler = function (_RecaptchaHandler) {
    ...
    (0, _createClass3.default)(OURLHandler, [{
      ...
      key: 'getURL',
      value: function () {
        var _ref99 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee97(jFormObject) {
  ...
  var StagedHandler = function (_AbstractHandler3) {
    ...
    (0, _createClass3.default)(StagedHandler, [{
            ...
            while (1) {
              switch (_context98.prev = _context98.next) {
                case 0:
                  ...
                  return _context98.abrupt('return', document);
                case 3:
                ...
                case 7:
                  page = _context98.sent;
                  page = _ADSBYPASSER_NAMESPACE__.$.toDOM(page);
                  return _context98.abrupt('return', page);
                case 10:
                case 'end':
      ...
      key: 'getURL',
      value: function () {
        var _ref101 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee99(page) {
          var f, args, url, data;
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  start: function () {
    var _ref111 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee109(m) {
      var url;
...
(function () {
  var hostRules = [/^sh\.st$/, /^(jnw0|cllkme|clkmein|corneey|ceesty)\.com$/, /^[dfg]estyy\.com$/, /^([vw]iid|clkme)\.me$/];
  _ADSBYPASSER_NAMESPACE__._.register({
    rule: {
      host: hostRules,
      path: /^\/freeze\/.+/
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  {
    host: [/\.blogspot\.com?/, /^simaholina\.xyz$/, /^(www\.)?id-securelink\.xyz$/, /^(www\.)?tojros\.tk$/, /^(www\.)?designmyhomee\.com$/, /^(www\.)?anjay\.info$/, /^(www\.)?kakkoiisafe\.us$/, /^(www\.)?kurosafe\.(website|online)$/, /^(www\.)?losstor\.com$/, /^kurosafe\.menantisenja\.com$/],
    query: [
    /^\?url=([a-zA-Z0-9/=]+)$/, /^\?id=([a-zA-Z0-9/=]+)$/, /^\?site=([a-zA-Z0-9/=]+)$/]
  }, {
    host: [/^sehatlega\.com$/, /^businessforyouand\.me$/],
    query: /^\?r=([a-zA-Z0-9/=]+)$/
  }, {
...
_ADSBYPASSER_NAMESPACE__._.register({
  rule: {
    host: [/^(gameinfo|apasih)\.pw$/, /^(www\.)?lifesurance\.info$/, /^intercelestial\.com$/],
    query: /^\?id=([a-zA-Z0-9/=]+)$/
  },
  ready: function () {
...
_ADSBYPASSER_NAMESPACE__._.register({
  rule: [{
    host: [/^(ani-share|autolinkach)\.com$/, /^motonews\.club$/, /^sehatsegar\.net$/, /^(autofans|landscapenature)\.pw$/, /^(www\.)?lifesurance\.info$/, /^(www\.)?bolaoke\.club$/],
    query: /get=([^&]+)/
  }, {
    host: [/^(gameinfo|apasih)\.pw$/, /^(www\.)?lifesurance\.info$/, /^intercelestial\.com$/]
  }],
...
_ADSBYPASSER_NAMESPACE__._.register({
  rule: {
    host: [/^www\.njiir\.com$/, /^(www\.)?anjay\.info$/, /^(www\.)?tetew\.info$/]
  },
  ready: function () {
...
(function () {
  var getURL = function () {
    var _ref176 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee174(url) {
      var text, goodURL;
...
(function () {
  ...
  _ADSBYPASSER_NAMESPACE__._.register({
    ...
    start: function () {
      var _ref202 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee200(m) {
...
(function () {
  ...
  _ADSBYPASSER_NAMESPACE__._.register({
    rule: {
      host: [/^(www\.)?image(carry|dunk|porter|switch)\.com$/, /^(www\.)?pic(leet|turedip|tureturn)\.com$/, /^(www\.)?imgspice\.com$/, /^(www\.)?(piclambo|yankoimages)\.net$/]
    },
    ready: run
  });
})();
...
(function () {
  var run = function () {
    var _ref217 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee215(rp) {
      var i;
  ...
  _ADSBYPASSER_NAMESPACE__._.register({
    rule: {
      host: [/^imagexport\.com$/, /^imageshimage\.com$/]
    },
...
(function () {
  var helper = function () {
    var _ref227 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee225(doReplace) {
      var i;
    ...
    return function helper(_x52) {
      return _ref227.apply(this, arguments);
    };
  }();
  _ADSBYPASSER_NAMESPACE__._.register({
    rule: {
      host: [/^img(fantasy|nemo|curl)\.com$/, /^imagedomino\.com$/, /^0img\.net$/, /^bunnyforum\.org$/],
      query: /^\?[pv]=/
    },
...
(function () {
  var getAmbiguousForm = function () {
    var _ref237 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee235(selector, shellNormalizer) {
        ...
        while (1) {
          switch (_context235.prev = _context235.next) {
            ...
            case 12:
              ...
              _ret = _loop(form);
              _context235.t0 = _ret;
              _context235.next = _context235.t0 === 'continue' ? 18 : 19;
              break;
            case 18:
              return _context235.abrupt('continue', 21);
            case 19:
              if (!((typeof _ret === 'undefined' ? 'undefined' : (0, _typeof3.default)(_ret)) === "object")) {
                _context235.next = 21;
                break;
              }
              return _context235.abrupt('return', _ret.v);
            case 21:
              _iteratorNormalCompletion = true;
              _context235.next = 12;
              break;
            ...
            case 26:
              _context235.prev = 26;
              _context235.t1 = _context235['catch'](10);
              _didIteratorError = true;
              _iteratorError = _context235.t1;
            case 30:
              _context235.prev = 30;
              _context235.prev = 31;
              if (!_iteratorNormalCompletion && _iterator.return) {
            ...
            case 33:
              ...
              throw _iteratorError;
            case 36:
              return _context235.finish(33);
            case 37:
              return _context235.finish(30);
            case 38:
              return _context235.abrupt('return', null);
            case 39:
            case 'end':
              return _context235.stop();
          }
        }
      }, _callee235, this, [[10, 26, 30, 38], [31,, 33, 37]]);
    }));
    return function getAmbiguousForm(_x54, _x55) {
      return _ref237.apply(this, arguments);
    };
  }();
  var helper = function () {
    var _ref238 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee236(id, getNext) {
    ...
    return function helper(_x56, _x57) {
      return _ref238.apply(this, arguments);
    };
  }();
  var go = function () {
    var _ref239 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee237(id, pre, next) {
    ...
    return function go(_x58, _x59, _x60) {
  ...
  _ADSBYPASSER_NAMESPACE__._.register({
    rule: {
      host: [/^img(monkey|trex|ve|dew)\.com$/, /^(www\.)?imgsee\.me$/, /^imgclick\.net$/, /^(uploadrr|imageeer|www\.uimgshare|pic-maniac|hulkimge)\.com$/],
      path: PATH_RULE
    },
    ready: function () {
...
(function () {
  var helper = function () {
    ...
    return function helper(_x64) {
      return _ref248.apply(this, arguments);
    };
  }();
  _ADSBYPASSER_NAMESPACE__._.register({
    rule: {
      host: [/^(miragepics|funextra\.hostzi)\.com$/, /^bilder\.nixhelp\.de$/, /^imagecurl\.(com|org)$/],
      path: /^\/viewer\.php$/,
      query: /file=([^&]+)/
    },
    start: helper
...
(function () {
  var action = function () {
    var _ref276 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee274(firstSelector, secondSelector) {
      var node, i;
    ...
    return function action(_x67, _x68) {
  ...
  _ADSBYPASSER_NAMESPACE__._.register({
    rule: [{
      ...
      /^img(icy|savvy|tzar|tornado|kicks|2share|hit|main|trial|reputa|fapper|part|balana)\.com$/, /^(i\.)?imgseeds?\.com$/,
      /^img-(planet|pay)\.com$/,
      /^www\.imglemon\.com$/,
      /^xxxscreens\.com$/, /^xxxwebdlxxx\.org$/,
      /^(wpc8|dimtus|tinizo)\.com$/, /^(i|xxx)\.hentaiyoutube\.com$/, /^erimge\.com$/, /^nimzshare\.com$/,
      /^img(serve|-view|project|python|pix)\.net$/, /^(naughtygate|gallerycloud|funimg|xximg)\.net$/,
      /^image(on|team)\.org$/, /^(voyeur|teen|mega)image\.org$/, /^teenshot\.org$/, /^img(studio|spot)\.org$/,
      /^www\.hotimage\.uk$/, /^hotimages\.eu$/, /(^|\.)55888\.eu$/, /^imgcloud\.co$/, /^pixup\.us$/, /^(pop-img|ads-img)\.info$/, /^(domaink|porno-pirat)\.ru$/, /^xxx\.pornscreen\.xyz$/, /^picz\.site$/, /^darpix\.ga$/, /^ipicture\.su$/, /^acidimg\.cc$/, /^s\.imghost\.top$/, /^pic\.hotimg\.site$/],
      path: /^\/img-.*\.html/
    }, {
