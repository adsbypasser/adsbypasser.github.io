...
// @icon           https://raw.githubusercontent.com/adsbypasser/adsbypasser/v6.15.0/resources/img/logo.png
...
// @grant          unsafeWindow
// @resource       alignCenter https://raw.githubusercontent.com/adsbypasser/adsbypasser/v6.15.0/resources/css/align_center.css
// @resource       scaleImage https://raw.githubusercontent.com/adsbypasser/adsbypasser/v6.15.0/resources/css/scale_image.css
// @resource       bgImage https://raw.githubusercontent.com/adsbypasser/adsbypasser/v6.15.0/resources/img/imagedoc-darknoise.png
...
(function () {
  ...
  var hostRules = [
  /^(([\w]{8}|www)\.)?(allanalpass|drstickyfingers|whackyvidz)\.com$/, /^(([\w]{8}|www)\.)?link(babes|bucks)\.com$/, /^(([\w]{8}|www)\.)?theseblogs\.com$/, /^warning-this-linkcode-will-cease-working-soon\.www\.linkbucksdns\.com$/,
  /^(([\w]{8}|www)\.)?(filesonthe|poontown|seriousdeals|urlbeat|zatnawqy)\.net$/, /^(([\w]{8}|www)\.)?freean\.us$/, /^(([\w]{8}|www)\.)?(miniurls|qqc|rqq|tinylinks|yyv)\.co$/, /^(([\w]{8}|www)\.)?youfap\.me$/];
  _ADSBYPASSER_NAMESPACE__._.register({
    rule: {
      host: hostRules,
      path: /^\/\w+\/url\/(.+)$/
...
(function () {
  var getJQueryForm = function () {
    var _ref102 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee100(selector) {
      var jQuery, f;
        ...
        while (1) {
          switch (_context100.prev = _context100.next) {
            ...
            case 7:
              ...
              return _context100.abrupt('return', f);
            case 10:
              return _context100.abrupt('return', null);
            case 11:
            case 'end':
    ...
    return function getJQueryForm(_x23) {
  ...
  _ADSBYPASSER_NAMESPACE__._.register({
    rule: {
      host: [
      /^(dz4link|gocitlink|3rabcut|short2win)\.com$/, /^(tmearn|payshorturl|urltips|shrinkearn)\.com$/, /^(earn-url|bit-url|cut-win|link-zero|cut-earn)\.com$/, /^(vy\.)?adsvy\.com$/, /^(linkexa|admew|shrtfly|kuylink|cut4links)\.com$/,
      /^(safelinku|tinylinks|licklink|linkrex|zlshorte)\.net$/, /^(vn|vina|fox)url\.net$/, /^(www\.)?linkdrop\.net$/,
      /^(trlink|wolink|tocdo|megaurl)\.in$/, /^(petty|tr)\.link$/, /^idsly\.(com|bid)$/, /^(adbilty|adpop|payskip|wicr)\.me$/, /^wi\.cr$/, /^(oke|cuon)\.io$/, /^(3bst|coinlink|itiurl)\.co$/, /^(shink|shrten|gg-l)\.xyz$/, /^mlink\.club$/, /^(igram|gram)\.im$/, /^clk\.press$/, /^short\.pe$/, /^urlcloud\.us$/, /^(123link|clik|tokenfly)\.pw$/, /^(icutit|earnbig|cutearn)\.ca$/, /^koylinks\.win$/, /^lopte\.pro$/, /^(www\.)?pnd\.tl$/, /^(tny|tiny)\.ec$/, /^tl\.tc$/]
    },
    ready: function () {
  ...
  _ADSBYPASSER_NAMESPACE__._.register({
    rule: {
      host: [
      /^(cut-urls|linclik|premiumzen|shrt10|itiad|by6dk|mikymoons|man2pro|mykinggo)\.com$/, /^short\.pastewma\.com$/, /^linkfly\.gaosmedia\.com$/, /^ads(horte|rt)\.com$/, /^(www\.)?viralukk\.com$/, /^(ot|load)url\.com$/, /^(cut4|rao)link\.com$/,
      /^www\.worldhack\.net$/, /^(eklink|vivads)\.net$/,
      /^(coshink|urle|adshort)\.co$/, /^(weefy|adbull|zeiz|link4)\.me$/, /^(adbilty|taive)\.in$/, /^(psl|twik|adslink)\.pw$/, /^(curs|crus|4cut|u2s|l2s)\.io$/, /^dzurl\.ml$/, /^petty\.link$/, /^shortad\.cf$/, /^123link\.(io|co|press)$/, /^git\.tc$/, /^adfu\.us$/, /^shortit\.ca$/, /^spamlink\.org$/, /^royurls\.bid$/]
    },
    ready: function () {
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  ready: function () {
    var _ref104 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee102(m) {
        ...
        while (1) {
          switch (_context103.prev = _context103.next) {
            ...
            case 6:
              ...
              return _context103.abrupt('break', 13);
            case 10:
...
(function () {
  var hostRules = [
  /^(jnw0|cllkme|clkmein|corneey|ceesty)\.com$/, /^[dfg]estyy\.com$/,
  /^sh\.st$/, /^([vw]iid|clkme)\.me$/];
  _ADSBYPASSER_NAMESPACE__._.register({
    rule: {
      host: hostRules,
      path: /^\/freeze\/.+/
...
_ADSBYPASSER_NAMESPACE__._.register({
  ...
  {
    host: [
    /\.blogspot\.com?/, /^(www\.)?designmyhomee\.com$/, /^(www\.)?losstor\.com$/, /^kurosafe\.menantisenja\.com$/,
    /^(simaholina|autech)\.xyz$/, /^(www\.)?id-securelink\.xyz$/,
    /^(www\.)?tojros\.tk$/, /^(www\.)?anjay\.info$/, /^(www\.)?kakkoiisafe\.us$/, /^(www\.)?kurosafe\.(website|online)$/],
    query: [
    /^\?url=([a-zA-Z0-9/=]+)$/, /^\?id=([a-zA-Z0-9/=]+)$/, /^\?site=([a-zA-Z0-9/=]+)$/]
  }, {
    host: [/^sehatlega\.com$/, /^businessforyouand\.me$/, /^plantaheim\.web\.id$/],
    query: /^\?r=([a-zA-Z0-9/=]+)$/
  }, {
...
_ADSBYPASSER_NAMESPACE__._.register({
  rule: {
    host: [/^(gameinfo|apasih)\.pw$/, /^(www\.)?lifesurance\.info$/, /^(intercelestial|sweetlantern)\.com$/],
    query: /^\?id=([a-zA-Z0-9/=]+)$/
  },
  ready: function () {
...
(function () {
  var getURL = function () {
    var _ref177 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee175(url) {
      var text, goodURL;
...
(function () {
  var getAmbiguousForm = function () {
    ...
    return function getAmbiguousForm(_x55, _x56) {
  ...
  var helper = function () {
    ...
    return function helper(_x57, _x58) {
  ...
  var go = function () {
    ...
    return function go(_x59, _x60, _x61) {
...
_ADSBYPASSER_NAMESPACE__._.register({
  rule: {
    host: [/^www\.pixsense\.net$/, /^www\.imagespicy\.site$/, /^www\.img(sky|file)\.net$/],
    path: /^\/site\/v\/\d+$/
  },
  ready: function () {
...
(function () {
  var action = function () {
    var _ref278 = (0, _asyncToGenerator3.default)( _regenerator2.default.mark(function _callee276(firstSelector, secondSelector) {
      var node, i;
    ...
    return function action(_x68, _x69) {
  ...
  _ADSBYPASSER_NAMESPACE__._.register({
    rule: [{
      host: [
      /^image(corn|decode|ko)\.com$/, /^(hostur|greasy|dam)image\.com$/, /^img(icy|savvy|tzar|tornado|kicks|2share|hit|main|trial|reputa|fapper|part|balana)\.com$/, /^(i\.)?imgseeds?\.com$/, /^img-(planet|pay)\.com$/, /^www\.imglemon\.com$/, /^xxxscreens\.com$/, /^(wpc8|dimtus|tinizo|erimge|nimzshare)\.com$/, /^(i|xxx)\.hentaiyoutube\.com$/,
      /^(xxxwebdlxxx|teenshot)\.org$/, /^image(on|team)\.org$/, /^(voyeur|teen|mega)image\.org$/, /^img(studio|spot)\.org$/,
      /^img(serve|project|python|pix)\.net$/, /^img-view\.net$/, /^(naughtygate|gallerycloud)\.net$/, /^(fun|xx)img\.net$/,
