...
(function () {
  ...
  var AbstractHandler = function () {
    ...
    (0, _createClass2["default"])(AbstractHandler, [{
      ...
      key: "call",
      value: function () {
        var _call = (0, _asyncToGenerator2["default"])( _regenerator["default"].mark(function _callee54() {
          var ok, mw, url;
  ...
  var RecaptchaHandler = function (_AbstractHandler) {
    ...
    (0, _createClass2["default"])(RecaptchaHandler, [{
      key: "prepare",
      value: function () {
        var _prepare = (0, _asyncToGenerator2["default"])( _regenerator["default"].mark(function _callee55() {
          var f, b;
      ...
      key: "submitListen",
      value: function () {
        var _submitListen = (0, _asyncToGenerator2["default"])( _regenerator["default"].mark(function _callee56(b) {
          var o;
      ...
      key: "getMiddleware",
      value: function () {
        var _getMiddleware = (0, _asyncToGenerator2["default"])( _regenerator["default"].mark(function _callee57() {
      ...
      key: "getURL",
      value: function () {
        var _getURL = (0, _asyncToGenerator2["default"])( _regenerator["default"].mark(function _callee58(jForm) {
          var url;
            ...
            while (1) {
              switch (_context58.prev = _context58.next) {
                ...
                case 11:
                  ...
                  _ADSBYPASSER_NAMESPACE__._.warn(_context58.t0);
                case 14:
                  _context58.next = 0;
                  break;
                case 16:
  ...
  function _getJQueryForm() {
    _getJQueryForm = (0, _asyncToGenerator2["default"])( _regenerator["default"].mark(function _callee59(selector) {
      var jQuery, f;
        ...
        while (1) {
          switch (_context59.prev = _context59.next) {
            ...
            case 7:
              ...
              return _context59.abrupt("return", f);
            case 10:
...
_ADSBYPASSER_NAMESPACE__._.register({
  rule: {
    host: [/^crownimg\.com$/, /^fotokiz\.com$/, /^imgbaron\.com$/, /^imgsen\.com$/, /^imgsto\.com$/, /^kropic\.com$/, /^kvador\.com$/, /^picbaron\.com$/, /^picdollar\.com$/, /^pics4upload\.com$/, /^silverpic\.com$/, /^barbit\.net$/, /^pics4you\.net$/, /^imgstar\.eu$/, /^www\.fappic\.com$/]
  },
  ready: function ready() {
...
_ADSBYPASSER_NAMESPACE__._.register({
  rule: {
    host: [/^2i\.(cz|sk)$/, /^(picnew|rintor)\.space$/, /^[0-9]{1,3}xpics\.space$/, /^imgcloud\.pw$/, /^pilot007\.org$/, /^img\.javstore\.net$/, /^www\.imghit\.com$/, /^xxxaddicted\.top$/],
    path: /^\/(image|i)\/.*/
  },
  ready: function ready() {
...
(function () {
  ...
  function _helper() {
    _helper = (0, _asyncToGenerator2["default"])( _regenerator["default"].mark(function _callee148(m) {
