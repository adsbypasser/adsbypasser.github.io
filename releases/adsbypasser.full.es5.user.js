...
(function () {
  ...
  var AbstractHandler = function () {
    ...
    (0, _createClass2["default"])(AbstractHandler, [{
      ...
      key: "call",
      value: function () {
        var _call = (0, _asyncToGenerator2["default"])( _regenerator["default"].mark(function _callee48() {
          var ok, mw, url;
  ...
  var RecaptchaHandler = function (_AbstractHandler) {
    ...
    (0, _createClass2["default"])(RecaptchaHandler, [{
      key: "prepare",
      value: function () {
        var _prepare = (0, _asyncToGenerator2["default"])( _regenerator["default"].mark(function _callee49() {
          var f, b;
      ...
      key: "submitListen",
      value: function () {
        var _submitListen = (0, _asyncToGenerator2["default"])( _regenerator["default"].mark(function _callee50(b) {
          var o;
      ...
      key: "getMiddleware",
      value: function () {
        var _getMiddleware = (0, _asyncToGenerator2["default"])( _regenerator["default"].mark(function _callee51() {
      ...
      key: "getURL",
      value: function () {
        var _getURL = (0, _asyncToGenerator2["default"])( _regenerator["default"].mark(function _callee52(jForm) {
          var url;
            ...
            while (1) {
              switch (_context52.prev = _context52.next) {
                ...
                case 6:
                  ...
                  return _context52.abrupt("return", url);
                case 9:
                  _context52.next = 14;
                  break;
                case 11:
                  ...
                  _ADSBYPASSER_NAMESPACE__._.warn(_context52.t0);
                case 14:
                  _context52.next = 0;
                  break;
                case 16:
  ...
  function _getJQueryForm() {
    _getJQueryForm = (0, _asyncToGenerator2["default"])( _regenerator["default"].mark(function _callee53(selector) {
      var jQuery, f;
        ...
        while (1) {
          switch (_context53.prev = _context53.next) {
            ...
            case 7:
              ...
              return _context53.abrupt("return", f);
            case 10:
      ...
      return _regenerator["default"].wrap(function _callee111$(_context111) {
        while (1) {
          switch (_context111.prev = _context111.next) {
            case 0:
              a = (0, _ADSBYPASSER_NAMESPACE__.$)('#continue > a');
              if (a) {
                a.click();
              }
...
_ADSBYPASSER_NAMESPACE__._.register({
  rule: ['https://2i.cz/i/*', 'https://2i.sk/i/*', 'https://www.imagehost.at/image/*'],
  ready: function ready() {
...
_ADSBYPASSER_NAMESPACE__._.register({
  rule: {
    host: [/^cloudgallery\.net$/, /^imgair\.net$/, /^imgblaze\.net$/, /^imgfrost\.net$/, /^imgqklw\.shop$/, /^imgrehd\.shop$/, /^imgtgd\.shop$/]
  },
  ready: function ready() {
...
_ADSBYPASSER_NAMESPACE__._.register({
  rule: {
    host: [/^37xpics\.space$/, /^imgcloud\.pw$/, /^pilot007\.org$/, /^www\.imghit\.com$/],
    path: /^\/image\/.*/
  },
  ready: function ready() {
      ...
      return _regenerator["default"].wrap(function _callee124$(_context124) {
        while (1) {
          switch (_context124.prev = _context124.next) {
            case 0:
              a = (0, _ADSBYPASSER_NAMESPACE__.$)('.button.blue');
              if (a) {
                a.click();
              }
      ...
      return _regenerator["default"].wrap(function _callee129$(_context129) {
        while (1) {
          switch (_context129.prev = _context129.next) {
            case 0:
              a = (0, _ADSBYPASSER_NAMESPACE__.$)('#continuebutton');
              if (a) {
                a.click();
              }
              a = (0, _ADSBYPASSER_NAMESPACE__.$)('.centred');
...
_ADSBYPASSER_NAMESPACE__._.register({
  rule: ['https://ai18.pics/upload/en/*', 'https://cnpics.org/upload/en/*', 'https://cnxx.me/upload/en/*', 'https://cosplay18.pics/upload/en/*', 'https://idol69.net/upload/en/*', 'https://img.javstore.net/image/*', 'https://javball.com/upload/en/*', 'https://ovabee.com/upload/en/*', 'https://picnew.space/image/*', 'https://pig69.com/upload/en/*', 'https://porn4f.com/upload/en/*', 'https://xxxaddicted.top/image/*'],
  ready: function ready() {
...
(function () {
  ...
  function _helper() {
    _helper = (0, _asyncToGenerator2["default"])( _regenerator["default"].mark(function _callee132(m) {
